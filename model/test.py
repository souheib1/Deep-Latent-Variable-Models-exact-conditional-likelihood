...
def plot_generated_samples(samples, save_path=None):
...
if __name__ == "__main__":
    ...
    model = VAE()
    model.load_state_dict(torch.load('model_weights/VAE_MNIST_zdim_64_epochs_50.pth'))
    model.eval()
